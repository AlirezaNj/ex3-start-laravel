...
<div class="container text-right">
    ...
    <h1>ویرایش سوال</h1>
    <br>
    <form action="{{route('questions.update' , ['question'=>$question])}}" method="POST" dir="rtl">
        @method('PATCH')
        @csrf
        ...
        <div class="form-group">
            ...
            <input type="text" name="correctOpt" class="form-control" id="correctOpt" value="{{$question->correctOpt}}">
        </div><br>
